  ...
  return (
    <div style={{ backgroundColor: '#f8f9fa', minHeight: '100vh', width: '100%', fontFamily: 'sans-serif', margin: 0, padding: 0 }}>
      ...
      <div style={{ 
        ...
        display: 'flex',
        justifyContent: (currentArea === '極上仕上場' || currentArea === 'タワー') ? 'center' : 'flex-start'
      }}>
        <div style={{ 
          display: 'grid', 
          // --- ここがレイアウトの核 ---
          gridTemplateColumns: 
            ...
            'repeat(8, 1fr)', // 極上仕上場は8列

          gap: '12px',
          // --- 幅の制御 ---
          width: '95%',
          maxWidth: 
            currentArea === 'タワー' ? '500px' : 
            currentArea === '極上仕上場' ? 'none' : '950px',
          minWidth: 
            currentArea === '極上仕上場' ? '900px' : 'auto', 
